...
- [Blinking with ORANGE and GREEN LED's](<6780_lab1_GPIO/Main files/Main ORANGE and GREEN/main.c>)

### 1.5.1.b Changing to the New LEDs
Recreate the blinking demo using the red and blue LEDs on the Discovery board:

- [Blinking with RED and BLUE LED's](<6780_lab1_GPIO/Main files/Main RED and BLUE/main.c>)
...
- [Input and reading a button](<6780_lab1_GPIO/Main files/Main Button/main.c>)
